...
## FS3 Postgresql Configuration

A PostgreSQL database is required to be pre-built for FS3 server usage. The database schema and tables schema are listed below.
### Database Schema
```sh
                          List of relations
